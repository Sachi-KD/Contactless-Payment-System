            ...
            <div class="right-side">
                <nav>
                    <div class="title d-flex align-items-end">
                        ...
                        <p class="p-0 m-0">&nbsp;Welcome, <%= (String) session.getAttribute("username")%></p>
                    </div>
                    <div class="list">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                ...
                                <form class="text-center mt-2" action="logOutServlet" method="post">
                                    <button id="logoutButton" type="submit" class="logout-button btn btn-outline-primary">
                        ...
                        <div class="pay-left">
                            ...
                            <form action="EventCreateServlet" method="post">
                                <div class="ticket">
                                    ...
                                    <input type="hidden" name="clientname" value="<%= (String) session.getAttribute("username")%>"/>
                                    <div class="exchange">
                        ...
                        <div class="pay-right">
                            ...
                            <div class="items">
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="title">
                                            <p class="special-value bold">You are paying</p>
                                        </div>
                                        <div class="value">
                                            <p class="special-value">2500 LKR</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="row">
                                        ...
                                        <div class="value">
                                            <p class="normal-value">0.00212455 USD</p>
                                        </div>
                                    </div>
                                </div>
