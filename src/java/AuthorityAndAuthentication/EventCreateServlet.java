 ...
 * @author sachi
 */
@WebServlet(name = "EventCreateServlet", urlPatterns = {"/EventCreateServlet"})
public class EventCreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EventCreateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EventCreateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if(request.getParameter("eveName").equals(null) || request.getParameter("eveName").isEmpty()){
            ...
            eve.setEventDateTime(LocalDateTime.parse(request.getParameter("eveDate")));
            eve.CreateEvent();
