                                    ...
                                    <table class="table table-bordered table-striped mb-0">
                                        ...
                                        <form action="GenerateQrServlet" method="post">
                                            <tr>
                                                ...
                                                <td> 
                                                    <input type="hidden" name="billId" value="<%= event.getEveId() %>"/>
                                                    <input type="hidden" name="usernames" value="<%= event.getClientName() %>"/>
                                                    <input type="hidden" name="billName" value="<%= event.getEventName() %>"/>
